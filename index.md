...
constructor performs an **inner-holdout race** between the two families
...
`adaptive` lands within 0.3 pp of the cost-sensitive STreeD baseline
while preserving strict chain-FFT structure (depth ≤ 4, one cue per
node, binary exits), and it does so without breaking the FFT
...
See
[`vignette("quickstart")`](https://travisjakel.github.io/adaptiveFFT/articles/quickstart.md)
for the full walkthrough and
[`vignette("benchmark")`](https://travisjakel.github.io/adaptiveFFT/articles/benchmark.md)
to reproduce the paper’s leaderboard.
...
GPL-3.0-or-later. Built on top of the GPL-2
[FFTrees](https://CRAN.R-project.org/package=FFTrees) package by
Phillips, Neth, Woike & Gaissmaier.

------------------------------------------------------------------------

Maintained by [Travis Jakel](https://github.com/travisjakel) at [Asset
Flow Capital](https://assetflow.ai).
